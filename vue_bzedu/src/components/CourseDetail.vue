        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <div class="sale-time">
                        <p class="sale-type">{{data.activities_name}}</p>
                        <p v-if="data.activities_name" class="expire">距离优惠结束：仅剩 {{parseInt(data.surplus_time/(24*3600))}}天 {{parseInt(data.surplus_time/3600%24)}}小时 {{parseInt(data.surplus_time/60%60)}}分 <span class="second">{{data.surplus_time%60}}</span> 秒</p>
                    </div>
                    <p class="course-price">
                        <span>活动价</span>
                        <span class="discount">¥{{data.true_price}}</span>
                    ...
                    <div class="buy">
                        ...
                        <div class="add-cart" @click="add_shoppingcart">加入购物车</div>
                    </div>
                </div>
            </div>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="(data,index) in chapter_lesson" :key="index">
                            <p class="chapter-title">第{{data.chapter}}章 {{data.name}}</p>
    ...
    export default {
        ...
        data() {
            return {
                ...
                playerOptions: {
                    ...
                    poster: "../static/image/wyy.jpg", //视频封面图
        ...
        methods: {
            ...
            add_shoppingcart(){
                ...
                this.$axios.post(`${this.$settings.HOST}shoppingcart/option/`,{
                    ...
                    this.$store.commit('change_count',success.data.course_count)
                }).catch(error=>{
            ...
            one_course(){
                this.$axios({
                    ...
                    //替换视频和图片
                    this.playerOptions.sources[0].src=success.data.video
                    // this.playerOptions.poster=success.data.course_img;
                  //活动时间倒计时
                    if (this.data.surplus_time>0){
                        let time = setInterval(()=>{
                            if (this.data.surplus_time>1){
                                this.data.surplus_time-=1
                            }else {
                                clearInterval(time)
                            }
                        },1000)
